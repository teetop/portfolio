          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mb-12 lg:mb-16">
              ...
              <p className="text-base sm:text-lg lg:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed px-4 sm:px-0">
                {totalYears}+ years of building revolutionary blockchain solutions, from smart contracts, ZK prrof research, to                       protocol architecture, with a proven track record of delivering secure, scalable, and innovative systems.
              </p>
